...
int main()
{
    ...
    // -------------------------
	string vertexShaderPath = solutionDir + "\\depth_testing.vs";
	string fragmentShaderPath = solutionDir + "\\depth_testing.fs";
	string outlineFragmentShaderPath = solutionDir + "\\FragmentSingle.fs";
    ...
    // load textures
    // -------------
	string cubeTexturePath = "marble.jpg";
	string floorTexturePath = "metal.png";
